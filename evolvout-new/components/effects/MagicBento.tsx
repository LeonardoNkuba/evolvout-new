  ...
  useEffect(() => {
    ...
    spotlight.style.cssText = `
      ...
      background: radial-gradient(circle,
        rgba(${glowColor}, 0.04) 0%,
        rgba(${glowColor}, 0.02) 15%,
        rgba(${glowColor}, 0.01) 25%,
        rgba(${glowColor}, 0.005) 40%,
        rgba(${glowColor}, 0.002) 65%,
        transparent 70%
      );
      z-index: 200;
      opacity: 0;
      ...
      const targetOpacity =
        minDistance <= proximity
          ...
          : minDistance <= fadeDistance
            ? ((fadeDistance - minDistance) / (fadeDistance - proximity)) * 0.12
            : 0;
            ...
            return (
              ...
              >
                ...
                <div className="magic-bento-card__content">
                  <h2 className="magic-bento-card__title">{card.value}</h2>
